...
<!-- Mirrored from byrushan.com/projects/super-admin/app/2.1.2/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 04 Mar 2019 09:48:31 GMT -->
<head>
        <meta charset="utf-8">
        ...
        <div class="login">
            ...
            <div class="login__block active" id="l-login">
                <div class="login__block__header">
                    ...
                    Hi there! Please Sign in to <br> <?php echo $this->config->item('company_name');?>
                ...
                <div class="login__block__body">
                     <div class="form-group">
                        <select class="form-control" id="role_id">
                         <option value="0">Select Role</option>
                            ...
                            <option value="<?php echo $roleList['all_list'][$i]['role_id'];?>"><?php echo $roleList['all_list'][$i]['role_name'];?></option>
                            <?php } } ?>
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control text-center" onblur="ValidateEmail(this.value)" id="email_id" placeholder="Email Address">
                        <span id="email_id-error"></span>
                    </div>

                    <div class="form-group">
                        <input type="password" class="form-control text-center" id="passwrd" placeholder="Password">
                        <span id="passwrd-error"></span>
                    </div>
<!--onclick="sign_in()"-->
                    <a href="javascript:void(0)"  id="login_in_sign"   class="btn btn--icon login__block__btn"><i class="zmdi zmdi-long-arrow-right"></i></a>
                </div>

                          ...
                          <div class="row">  
                               <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" class="form-control" placeholder="Name" name="start_date" id="menu_name" value="<?php echo date("d-m-Y H:i", strtotime($orgDate));   ?>" >
                        ...
                        <?php //echo $dataList['all_list'][0]['end_date']; ?>
                             <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" class="form-control" placeholder="Name" name="end_date" id="menu_name" value="<?php echo $dataList['all_list'][0]['end_datetime']; ?>" >

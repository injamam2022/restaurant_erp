                          ...
                          <div class="row">  
                               <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" placeholder="Name" name="start_date" id="menu_name" required>
                             ...
                             <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" placeholder="Name" name="end_date" id="menu_name" required>
                                        <i class="form-group__bar"></i>
                                         <span id="product_name-error"></span>
                                    </div>
                                </div> 

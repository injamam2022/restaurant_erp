                        ...
                        <div class="table-responsive">
                            <table id="data-table" class="table" >
                                ...
                                <tbody>
                                    ...
                                    ?>
                                    <tr>
                                        <td><?php echo $dataList['all_list'][$i]['assignmenu_id']?></td>
                                        <td><?php echo $dataList['all_list'][$i]['school_name']?></td>
                                        <td><?php echo $dataList['all_list'][$i]['menu_name']?></td>
                                        <td><?php echo $dataList['all_list'][$i]['start_date']?></td>
                                        <td><?php echo $dataList['all_list'][$i]['end_date']?></td>
                                        <td>
                                            <div class="btn-group mb-2 dropright">
                                               ...
                                               <div class="dropdown-menu" x-placement="right-start" style="position: absolute; transform: translate3d(104px, 0px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                   ...
                                                   <a class="dropdown-item" href="<?php echo base_url('AssignMenu/edit/').$dataList['all_list'][$i]['assignmenu_id']; ?>" ><i class="zmdi zmdi-edit zmdi-hc-fw"></i> Edit</a>
                                                   
                                                   <a class="dropdown-item" href="<?php echo base_url('AssignMenu/delete/').$dataList['all_list'][$i]['assignmenu_id']; ?>" ><i class="zmdi zmdi-delete zmdi-hc-fw"></i> Delete</a>
                                               </div>
                                           </div>

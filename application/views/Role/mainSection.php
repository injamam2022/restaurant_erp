                        ...
                        <div class="table-responsive">
                            <table id="data-table" class="table" >
                                ...
                                <tbody>
                                    ...
                                    ?>
                                    <tr>
                                        <td><?php echo $roleList['all_list'][$i]['role_id']?></td>
                                        <td><?php echo $roleList['all_list'][$i]['role_name']?></td>
                                        <td>
                                            <div class="btn-group mb-2 dropright">
                                               ...
                                               <div class="dropdown-menu" x-placement="right-start" style="position: absolute; transform: translate3d(104px, 0px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                     ...
                                                     <a class="dropdown-item" href="javascript:void(0);" onclick="editRole(<?php echo $roleList['all_list'][$i]['role_id'];?>,'view');"><i class="zmdi zmdi-edit zmdi-hc-fw"></i> View</a>
                                                   
                                                   <a class="dropdown-item" href="javascript:void(0);" onclick="editRole(<?php echo $roleList['all_list'][$i]['role_id'];?>,'edit');"><i class="zmdi zmdi-edit zmdi-hc-fw"></i> Edit</a>
                                                   
                                                   <a class="dropdown-item" href="javascript:void(0);" id="rowId_<?php echo $roleList['all_list'][$i]['role_id'];?>" onclick="deleteRole(<?php echo $roleList['all_list'][$i]['role_id'];?>);"><i class="zmdi zmdi-delete zmdi-hc-fw"></i> Delete</a>
                                               </div>
                                           </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <span id="role_name-error"></span>
                                
                                <span id="addmsg"></span>
                            </div>
                            
                            <div class="modal-footer">
                                <button type="button" class="btn btn-link" onclick="add_role()">Save changes</button>
                ...
                <div class="modal fade" id="edit_modal" tabindex="-1">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                 <label>Name</label>
                                <input type="text" class="form-control"  id="edit_role_name" placeholder="Role Name">
                                <span id="edit_role_name-error"></span>

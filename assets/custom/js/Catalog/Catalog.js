...
//                     document.getElementById("y").src="./images/test2.png"
                    var image='<img src="'+file_url+'/'+res.img+'" style="width:100px; height:100px;">';
...
function deleteCategory(category_id)
{
   ...
   swal({
                    ...
                    background: 'rgba(0, 0, 0, 0.96)'
                     ...
                     $.ajax({
                                type: "POST",
                                url: base_url+"OurClasses/deleteCategory",
...
function editCategory(catalog_id)
{
    

    $.ajax({
            type: "POST",
            url: base_url + "OurClasses/Singledata",
//            dataType: "json",
            data: {
        ...
        /*{"stat":200,"msg":"All list","list_count":1,"all_list":[{"catalog_id":"4","catalog_name":"catelog uhghjg","catalog_desc":"catelog ","catalog_img":"1570187983BONGOBASI____NEW.png","catalog_catid":"1","del_status":"0"}]}*/            


                    var content="";
                    GlobId=res.all_list[0].catalog_id;
                    $("#edit_catalaog_name").val(res.all_list[0].catalog_name);
                    $("#edit_catalaog_desc").val(res.all_list[0].catalog_desc);
                    content+='<img src="'+file_url+'/catalog/'+res.all_list[0].catalog_img+'" style="width:100px; height:100px"><input type="hidden" value="'+res.all_list[0].catalog_img+'" id="previousimage">';
                    $("#edit_catalog_catid").val(res.all_list[0].catalog_catid);
...
{
     clrmsg();
    var cat_name = $("#edit_catalaog_name").val();
    var previousimage = $("#previousimage").val();
    var cat_desc = $("#edit_catalaog_desc").val();
    var cat_img = $("#edit_catalaog_img").prop('files')[0];
    var cat_id_catlog = $("#edit_catalog_catid").val();
    ...
    form_data.append("cat_desc", cat_desc)
    form_data.append("cat_img", cat_img)
    form_data.append("cat_id_catlog", cat_id_catlog)
    ...
    $.ajax({
            type: "POST",
            url: base_url + "OurClasses/editCatalog",
            data: form_data,
            contentType: false,
            processData: false,
            type: 'POST',

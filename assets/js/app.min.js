...
var valuee = sessionStorage.getItem("valueeee");
   // alert(valuee);
    $("#thm_"+valuee).click();
    setTimeout(function () {
        $(".page-loader").fadeOut();
    ...
    $(document).ready(function () {
        ...
        $("body").on("click", ".themes__item", function (a) {
            ...
            //alert(b);
            sessionStorage.setItem("valueeee", b);
        ...
        if (
            ...
            $(".widget-calendar__body").fullCalendar({
                ...
                events: [
                    ...
                    { title: "Purus Nibh", start: "2016-08-07" },
                    ...
                    { title: "Amet Pharetra", url: "http://google.com/", start: "2016-08-30" },
                ],
            });
        ...
        $(".treeview")[0] && $(".treeview").tree({ data: l, closedIcon: $('<i class="zmdi zmdi-plus"></i>'), openedIcon: $('<i class="zmdi zmdi-minus"></i>') }),
            ...
            $(".text-counter")[0] &&
                $(".text-counter").each(function () {
                    ...
                    $(this).textcounter({ min: a, max: b, countDown: !0, inputErrorClass: "is-invalid", counterErrorClass: "text-orange" });
                });
    }),
    $(document).ready(function () {
        function a(a) {
